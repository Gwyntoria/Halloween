...
HI_S32 SAMPLE_VENC_1HD_H264(HI_VOID)
{
    ...
    PAYLOAD_TYPE_E enPayLoad[2]= {PT_H264, PT_H264};
    PIC_SIZE_E enSize[2] = {PIC_HD720, PIC_D1};//{PIC_HD1080, PIC_960H};//
...
******************************************************************************/
HI_S32 SAMPLE_VENC_1_1080P(HI_VOID)
{
    ...
    ******************************************/   
    ...
    u32BlkSize = SAMPLE_COMM_SYS_CalcPicVbBlkSize(gs_enNorm, PIC_HD1080, SAMPLE_PIXEL_FORMAT, 
